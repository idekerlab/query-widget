;(function() {
  ...
  /**
   * Component to display links for our projects
   */
  class IconBar extends HTMLElement {
    constructor() {
      ...
      this.innerHTML = `
        <div class="icon-bar">
          <h4 class="widget-label">NDEx Network Query</h4>
          <a href="http://www.ndexbio.org/" target="_blank">
          ...
          <a href="https://nrnb.org/" target="_blank">
            <img class="logo-icon" alt="National Resource for Network Biology" src="http://search-dev.ndexbio.org/static/media/nrnb-logo-mono-dark.5a41574a.svg" /></img>
          </a>
          <a href="https://www.wikipathways.org/index.php/WikiPathways" target="_blank">
      ...
      const widgetLabel = this.querySelector('.widget-label')
      widgetLabel.style.color = 'teal'
      widgetLabel.style.fontWeight = '300'
  ...
  class GeneListQuery extends HTMLElement {
    ...
    connectedCallback() {
      ...
      buttonPanel.style.width = '4em'
      buttonPanel.style.minWidth = '4em'
      buttonPanel.style.maxWidth = '4em'
  ...
  const NDEX_URL =
    'http://www.ndexbio.org/#/search?searchType=All&searchTermExpansion=false&searchString='
  class KeywordQuery extends HTMLElement {
    constructor() {
      ...
      this.innerHTML = `
        <div class="keyword-panel">
          <div class="command-panel">
            ...
            <drop-down-list id="list1" label="Search Examples"></drop-down-list>
            <drop-down-list id="list2" label="Featured Networks"></drop-down-list>
          </div>
          
          <div class="query-box">
            <input id="keyword-text" placeholder="Enter gene list..."/>
      ...
      const buttonPanel = this.querySelector('.command-panel')
      buttonPanel.style.height = '100%'
      buttonPanel.style.width = '10em'
      buttonPanel.style.minWidth = '10em'
      buttonPanel.style.maxWidth = '10em'
      buttonPanel.style.background = '#F5F5F5'
      buttonPanel.style.display = 'flex'
      buttonPanel.style.alignItems = 'center'
      buttonPanel.style.justifyContent = 'space-around'
      ...
      runButton.addEventListener('click', () =>
        this._onClick(keywordText.value, 'run')
      )

      const browseButton = this.querySelector('#browse-button')
      browseButton.addEventListener('click', () =>
        this._onClick(keywordText.value, 'browse')
      )
    }
  ...
  class DropDownList extends HTMLElement {
    constructor() {
      super()
      this.innerHTML = `
        <button class="button dropdown-button">${this.label}</button>
      ...
      dropdownButton.style.background = '#286090'
      dropdownButton.style.fontSize = '0.7em'
      dropdownButton.style.width = '10em'
      dropdownButton.style.height = '3em'
    }
